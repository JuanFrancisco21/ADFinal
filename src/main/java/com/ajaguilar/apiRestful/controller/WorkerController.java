...
public class WorkerController {
	 ...
	 */
	@ApiOperation(value = "Método para obtener una lista de todas los trabajadores de la BBDD.", notes = "", tags = "getAllWorker")
	@ApiResponses(value = {
	 ...
	 *         vacio.
	 */
	@ApiOperation(value = "Método obtener un trabajador mediante su id.", notes = "", tags = "getWorkerById")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK. El recurso se obtiene correctamente", response = Worker.class),
			@ApiResponse(code = 400, message = "Bad Request.Esta vez cambiamos el tipo de dato de la respuesta (String)", response = String.class),
			@ApiResponse(code = 500, message = "Error inesperado del sistema") })
	 ...
	 *         trabajador vacio.
	 */
	@ApiOperation(value = "Método para la actulización de un trabajador.", notes = "", tags = "updateWorker")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK. El recurso se obtiene correctamente", response = Worker.class),
			@ApiResponse(code = 400, message = "Bad Request.Esta vez cambiamos el tipo de dato de la respuesta (String)", response = String.class),
			@ApiResponse(code = 500, message = "Error inesperado del sistema") })
	 ...
	 *         trabajador vacio.
	 */
	@ApiOperation(value = "Método obtener un trabajador mediante su nombre.", notes = "", tags = "getWorkerByName")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK. El recurso se obtiene correctamente", response = Worker.class),
			@ApiResponse(code = 400, message = "Bad Request.Esta vez cambiamos el tipo de dato de la respuesta (String)", response = String.class),
			@ApiResponse(code = 500, message = "Error inesperado del sistema") })
	 ...
	 *         trabajador vacio.
	 */
	@ApiOperation(value = "Método obtener un trabajador mediante su apellido.", notes = "", tags = "getWorkerBySurname")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK. El recurso se obtiene correctamente", response = Worker.class),
			@ApiResponse(code = 400, message = "Bad Request.Esta vez cambiamos el tipo de dato de la respuesta (String)", response = String.class),
			@ApiResponse(code = 500, message = "Error inesperado del sistema") })
	 ...
	 *         lista vacia.
	 */
	@ApiOperation(value = "Método obtener un trabajador por si esta activo/inactivo.", notes = "", tags = "getWorkerByActive")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK. El recurso se obtiene correctamente", response = Worker.class),
			@ApiResponse(code = 400, message = "Bad Request.Esta vez cambiamos el tipo de dato de la respuesta (String)", response = String.class),
			@ApiResponse(code = 500, message = "Error inesperado del sistema") })
	 ...
	 *         WorkerWork vacio.
	 */
	@ApiOperation(value = "Método para introducir un trabajador en una obra.", notes = "", tags = "addWorkerToWork")
	@ApiResponses(value = {
