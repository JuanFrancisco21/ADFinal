...
public class WorkerService {
	...
	/**
	 * M�todo para obtener todos los trabajadores.
	 * 
	...
	/**
	 * M�todo para devolver un trabajador por su id.
	 * 
	...
	/**
	 * M�todo para crear nuevo trabajador, en caso de existir lo actuliza.
	 * 
	...
	/**
	 * M�todo para la acualizaci�n de trabajadores existentes en la BBDD.
	 * 
	 * @param Trabajador que se actulizar� en la BBDD.
	...
	/**
	 * M�todo para obtener un trabajador por su nombre.
	 * 
	...
	/**
	 * M�todo para obtener un trabajador por su apellido.
	 * 
	...
	/**
	 * M�todo para devolver una lista trabajadores segun si esta activo.
	...
	/**
	 * M�todo para el borrado de un trabajador, introduciendo su id.
	 * 
